...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-vayu-700 text-white shadow-sm hover:bg-vayu-800 active:bg-vayu-900",
        destructive:
          "bg-destructive text-destructive-foreground shadow-sm hover:bg-destructive/90",
        outline:
          "border border-vayu-700 bg-transparent text-vayu-700 shadow-sm hover:bg-vayu-700 hover:text-white",
        secondary:
          "bg-secondary text-secondary-foreground shadow-sm hover:bg-secondary/80",
        ghost:
          "hover:bg-accent hover:text-accent-foreground",
        link:
          "text-vayu-700 underline-offset-4 hover:underline",
        white:
          "bg-white text-vayu-800 shadow-md hover:bg-cream hover:shadow-lg",
        whatsapp:
          "bg-[#25D366] text-white hover:bg-[#20bc5b] shadow-sm",
        sand:
